const Discord = require('discord.js');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const client = new Discord.Client();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const moment = require('moment');
const zalgo = require('zalgolize');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
// const math = require('math-expression-evaluator');   // 
const figlet = require('figlet');   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const fs = require('fs');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const ms = require('ms');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const prefix = '-'

client.on('message', msg => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if (msg.content === 'باك') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      msg.reply('** :wink: وِلِـكُمِـ ﻧَوِرُتْ   :sparkling_heart:**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }
  });

client.on('message', msg => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if (msg.content === 'حمودي') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      msg.reply('**اكو خلل بلبوت ؟**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }
  });


client.on('message', msg => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if (msg.content === 'احبك') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      msg.reply('**لاتحتك يا اخوي لو سمحت**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }
  });
  ...
  client.on('message', msg => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if (msg.content === 'احبك') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      msg.reply('**حبك برص يا سافل**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }
  });
   ...
   client.on('message', msg => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if (msg.content === 'هلا') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      msg.reply('**هلا بيك :heart: **');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }
  });
  ...
  client.on("message", message => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(message.content.startsWith(prefix + 'v2min')) {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
     let args = message.content.split(" ").slice(1);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
       var nam = args.join(' ');
    
      if(!message.member.hasPermission('ADMINISTRATOR')) return    message.channel.send('`ADMINISTRATOR` للأسف هذه الخاصية تحتاج الى ').then(msg => msg.delete(6000))
      if (!nam) return message.channel.send(`<@${message.author.id}> يجب عليك ادخال اسم`).then(msg => msg.delete(10000))  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      message.guild.createChannel(nam, 'voice').then(c => setTimeout(() => c.delete(), 120000))   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
...
client.on("message", message => {    //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(message.content.startsWith(prefix + "emoji")) {   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        if(message.author.bot) return;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        var emojiid =  message.content.split(" ").slice(1).join(" ")   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        console.log(emojiid) 
        if(emojiid.length < "18" || emojiid.length > "18" || isNaN(emojiid)) return  message.channel.send(`- Usage  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
${prefix}emoji <EmojiID>`); 
        else    
        message.channel.send("This is the emoji that you requested:-",  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          { 
            files: [`https://cdn.discordapp.com/emojis/${emojiid}.png`]  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          }) 
        }  
})   
 ...
 client.on("message", message => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  if (message.channel.type === "dm") {    //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 

      message.channel.startTyping();    //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      setTimeout(() => {    //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        message.channel.stopTyping();    //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      }, Math.random() * (1 - 3) + 1 * 1000);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   
  }  
});  

const clans = {};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const system = {};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
const level = {};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
 
client.on('message',async message => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  if(message.author.bot) return;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  if(message.channel.type === 'dm') return;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
  let args = message.content.split(' ');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  let random = Math.floor(Math.random() * 5) + 2;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  let author = message.author;
 
  let xpLeft;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  let nameClan;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  let membersClan = [];  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  let levelClan = 0;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  if(!system[author.id]) system[author.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
  if(!level[author.id]) level[author.id] = {level: 1, xp: 1};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
 
  level[author.id].xp += (+random);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  if(level[author.id].xp >= 300) {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(level[author.id].xp > 300) xpLeft = level[author.id].xp - 300;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    level[author.id] = {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      level: level[author.id].level + 1,  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      xp: xpLeft  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    };
 
  }
  if(message.content.startsWith(prefix + "clan")) {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(message.content.split(' ')[0] !== `${prefix}clan`) return;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
    if(!args[1] || args[1] && args[1] === 'info') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  let embed = new Discord.RichEmbed()
  .setAuthor('الكلانات', message.author.avatarURL)  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  ...
  .setFooter(message.author.username, message.author.avatarURL);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
  message.channel.send(embed);
}
 
    if(args[1] && args[1] === 'create') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      let awaited = await message.channel.awaitMessages(r => r.author.id === message.author.id, { max: 1, time: 20000, errors: ['time']}).then(collected => {
        ...
        nameClan = collected.first().content;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      });
 
      m = await m.edit('**# جارى عمل الكلان**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      awaited = await setTimeout(async() => {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        let membersArray = {
          nameClan: {
            array: []
          }
        };
        let members = membersArray.nameClan.array;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        members.push(message.author.id);
        clans[nameClan] = {
          name: nameClan,
          createdAt: new Date().toLocaleString(),  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          level: levelClan,
          creator: message.author.id,  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          members: members,  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          applylist: [],  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          admins: []  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        };
 
        system[author.id] = {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          clan: nameClan,  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          joinedAt: new Date().toLocaleString(),  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          clanLevel: 0,  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          creator: message.author.id  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        };
 
        m = await m.edit('**# تم عمل الكلان بنجاح**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      }, 2300);
 
    }
    if(args[1] && args[1] === 'invite') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!system[author.id]) return message.channel.send("**# أنت لست بكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let clan = system[author.id].clan;
      if(system[author.id].clan === 'None') return message.channel.send('**# أنت لست بكلان**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      let mention = message.mentions.users.first();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!mention) return message.channel.send('**# منشن شخص لدعوته للكلان**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(clans[clan].members.includes(mention.id)) return message.channel.send("**# هذا العضو بالكلان بالفعل**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(clans[clan].members.length === 10) return message.channel.send("**# هذا الكلان وصل للحد الاقصى من الاعضاء يمكنك**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      let awaiting = await message.channel.awaitMessages(r => r.author.id === mention.id, {max: 1, time: 20000, errors:['time']}).then(collected => {
        collected.first().delete().catch();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        if(collected.first().content === 'نعم') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          clans[clan].members.push(mention.id);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
          system[author.id].members += 1;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
 
          system[mention.id] = {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
            clan: clan,
            joinedAt: new Date().toLocaleString(),  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
            clanLevel: 0,
            creator: clans[clan].creator  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          };
 
          message.channel.send(`**${message.author} # تم قبول الدعوة**`);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        }  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        if(collected.first().content === 'لا') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          message.channel.send(`**${message.author} # تم رفض الدعوة**`);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        } else if(collected.first().content !== 'نعم' && collected.first().content !== 'لا'){  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
          return message.channel.send('**# يجب عليك كتابة `نعم` أو `لا`**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        }  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      });  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(args[1] && args[1] === 'stats') {
      if(system[author.id].clan === 'None') return message.channel.send('**# يجب ان تكون بكلان لأستخدام هذا الأمر**');  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let clan = system[author.id].clan;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let embed = new Discord.RichEmbed()  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        .setAuthor(`${message.author.username} || الكلانات`, message.author.avatarURL)  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        .setDescription(`الكلان || \`${clan.toString()}\``)  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» اسم الكلان', clan, true)  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» تاريخ عمل الكلان', clans[clan].createdAt, true);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» تاريخ دخول الكلان', system[author.id].joinedAt, true)  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» صاحب الكلان', `<@${clans[clan].creator}>`, true);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» لفل الكلان', clans[clan].level, true);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» عدد اعضاء الكلان', clans[clan].members.length, true);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» عدد التقديمات للكلان', clans[clan].applylist.length, true);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» عدد الادمنية بالكلان', clans[clan].admins.length, true);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        embed.addField('» اعضاء الكلان', `${prefix}clan list || يظهرلك رسالة بها اعضاء الكلان`);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      message.channel.send(embed);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
    }
    if(args[1] && args[1] === 'join') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    let clanName = message.content.split(' ').slice(2).join(" ");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(system[author.id].clan !== 'None') return message.channel.send("**# يجب أن لا تكون بكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(!args[2]) return message.channel.send("**# يجب عليك كتابة اسم الكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(!clans[clanName]) return message.channel.send("**# هذا الكلان غير موجود**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(clans[clanName].applylist.includes(message.author.id)) return message.channel.send("**# لقد قدمت على دخول هذا الكلان مسبقا");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    clans[clanName].applylist.push(message.author.id);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    message.channel.send("**# لقد تم التقديم على دخول الكلان , سيتم الرد عليك من قبل احد ادارة الكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
  }
    if(args[1] && args[1] === 'accept') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let mention = message.mentions.users.first();
      if(system[author.id].clan === 'None') return message.channel.send("**# يجب عليك ان تكون بكلان لأستخدام هذا الأمر**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      if(!system[mention.id]) system[mention.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      clans[system[author.id].clan].applylist.shift(mention.id);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      clans[system[author.id].clan].members.push(mention.id);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let clan = system[author.id].clan;  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   ...
   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      mention.send(`**# \`${system[author.id].clan}\`, لقد تم قبولك بالكلان**`).catch();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      message.channel.send(`**# \`${mention.username}\`, لقد تم قبول الشخص ودخوله للكلان**`);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(args[1] && args[1] === 'decline') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let mention = message.mentions.users.first();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      ...
      system[mention.id] = {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        clan: clans[system[author.id].clan],  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
        joinedAt: new Date().toLocaleString(),
        clanLevel: 0  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      };
 
 
      mention.send(`**# \`${system[author.id].clan}\`, لقد تم رفض دخولك للكلان**`).catch();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      message.channel.send(`**# \`${mention.username}\`, لقد تم رفض دخول الشخص للكلان**`);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }
    if(args[1] && args[1] === 'promote') {
      ...
      if(system[mention.id].clan === 'None') return message.channel.send("**# هذا الشخص ليس بكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!clans[system[author.id].clan].members.includes(mention.id)) return message.channel.send("**# هذا الشخص ليس بالكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(clans[system[author.id].clan].admins.includes(mention.id)) return message.channel.send("**# هذا العضو لديه ادمن بالفعل**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(mention.id === message.author.id) return message.channel.send("**# لا يمكنك اعطاء نفسك ترقية**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
      clans[system[author.id].clan].admins.push(mention.id);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
 
 
      mention.send(`**# \`${system[author.id].clan}\`, لقد تم ترقيتك الى ادمن**`).catch();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      message.channel.send(`**# \`${mention.username}\`, لقد تم ترقية العضو الى رتبة ادمن**`);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    }  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
    if(args[1] && args[1] === 'demote') {  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      let mention = message.mentions.users.first();  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(system[author.id].clan === 'None') return message.channel.send("**# يجب ان تكون بكلان لأستخدام هذا الأمر**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(clans[system[author.id].clan].creator !== message.author.id) return message.channel.send("**# هذا الأمر لضاحب الكلان فقط**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!mention) return message.channel.send("**# يجب عليك منشنة عضو بالكلان لأعطائه الترقية**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!system[mention.id]) system[mention.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(system[mention.id].clan === 'None') return message.channel.send("**# هذا الشخص ليس بكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!clans[system[author.id].clan].members.includes(mention.id)) return message.channel.send("**# هذا الشخص ليس بالكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(!clans[system[author.id].clan].admins.includes(mention.id)) return message.channel.send("**# هذا الشخص ليس ادمن بالكلان**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      if(mention.id === message.author.id) return message.channel.send("**# لا يمكنك اعطاء نفسك ترقية**");  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
   //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
      clans[system[author.id].clan].admins.shift(mention.id);  //!  𝐇𝐌𝐎𝐃𝐘 《𝐆𝐒𝐆》🇮🇶#4779 
